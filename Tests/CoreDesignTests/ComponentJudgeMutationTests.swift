...
struct ComponentJudgeMutationTests {
    ...
    func copiedTreeReproducesBaseline() throws {
        ...
        #expect(judgeExtensionPoints(entries: entries, scan: copied).missing == ["AvatarGroup", "SidebarUtilityRow", "SpinningModifier", "Toast"])
    ...
    func j2EndToEndMutation() throws {
        ...
        #expect(result.missing == ["AvatarGroup", "Banner", "SidebarUtilityRow", "SpinningModifier", "Toast"],
