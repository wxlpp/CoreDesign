...
struct ComponentJudgeMutationTests {
    ...
    func copiedTreeReproducesBaseline() throws {
        ...
        #expect(judgeExtensionPoints(entries: entries, scan: copied).missing == ["SidebarUtilityRow", "SpinningModifier", "Toast"])
    ...
    func j2EndToEndMutation() throws {
        ...
        #expect(result.missing == ["Banner", "SidebarUtilityRow", "SpinningModifier", "Toast"],
