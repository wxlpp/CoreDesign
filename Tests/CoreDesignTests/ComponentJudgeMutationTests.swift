...
struct ComponentJudgeMutationTests {
    ...
    func copiedTreeReproducesBaseline() throws {
        ...
        #expect(judgeExtensionPoints(entries: entries, scan: copied).missing == ["AvatarGroup", "SidebarUtilityRow", "SpinningModifier", "Timeline", "Toast"])
    ...
    func j2EndToEndMutation() throws {
        ...
        #expect(result.missing == ["AvatarGroup", "Banner", "SidebarUtilityRow", "SpinningModifier", "Timeline", "Toast"],
