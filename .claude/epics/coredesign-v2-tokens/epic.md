...
- [x] #3 - CoreTypography token (parallel: true)
- [x] #4 - CoreElevation token + dark-adaptive shadow colorset (parallel: true)
- [x] #5 - CoreControlMetrics token (parallel: false)
- [x] #6 - 语义色补全 + Color.focusRing 重命名为 borderFocus (parallel: true)
- [x] #7 - SurfaceModifier (parallel: false)
- [x] #8 - FocusRingModifier 文件骨架 + iOS 端实现 (parallel: false)
- [x] #9 - FocusRingModifier macOS NSFocusRing 分支填充 (parallel: false)
- [x] #10 - BorderModifier canary 迁移 (parallel: true)
