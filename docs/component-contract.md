...
`docs/component-registry.json` 与本文件命中**均为 0**；⚠️ 本句自身与本轮回写文本对这两个词
的引用不计入该计数——`docs/contract-defects.md` D-44-3 里那组剩余候选是**该轮的推演**，
原文自带 hedge「登记表与源码均未成文枚举」）⇒ 皮肤变体条款这条路径**不承重**。
